...
class StackRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            final int dayColIndex = mCursor.getColumnIndex(WidgetDataProvider.Columns.DAY);
            final int tempColIndex = mCursor.getColumnIndex(
                    WidgetDataProvider.Columns.TEMPERATURE);
        ...
        rv.setTextViewText(R.id.widget_item1, String.format(formatStr, temp, day));
    ...
    public void onDataSetChanged() {
        ...
        mCursor = mContext.getContentResolver().query(WidgetDataProvider.CONTENT_URI, null, null,
                null, null);
    }
}
